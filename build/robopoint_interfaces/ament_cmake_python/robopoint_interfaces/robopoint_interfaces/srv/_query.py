...
class Query_Event(metaclass=Metaclass_Query_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robopoint_interfaces/Query_Request, 1>',
        'response': 'sequence<robopoint_interfaces/Query_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robopoint_interfaces', 'srv'], 'Query_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robopoint_interfaces', 'srv'], 'Query_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robopoint_interfaces.srv import Query_Request
    ...
    def response(self, value):
        if self._check_fields:
            from robopoint_interfaces.srv import Query_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Query(metaclass=Metaclass_Query):
    ...
    from robopoint_interfaces.srv._query import Query_Event as Event
