...
static const _MoveToPoint_Event_type_support_symbol_names_t _MoveToPoint_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robopoint_interfaces, srv, MoveToPoint_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robopoint_interfaces, srv, MoveToPoint_Event)),
  }
};
...
{
  return &::robopoint_interfaces::srv::rosidl_typesupport_cpp::MoveToPoint_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robopoint_interfaces, srv, MoveToPoint_Event)() {
  return get_message_type_support_handle<robopoint_interfaces::srv::MoveToPoint_Event>();
}
...
static const rosidl_service_type_support_t MoveToPoint_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robopoint_interfaces::srv::MoveToPoint_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robopoint_interfaces::srv::MoveToPoint_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robopoint_interfaces::srv::MoveToPoint_Event>(),
