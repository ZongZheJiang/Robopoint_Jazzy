...
enum
{
  robopoint_interfaces__srv__MoveToPoint_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robopoint_interfaces__srv__MoveToPoint_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/MoveToPoint in the package robopoint_interfaces.
typedef struct robopoint_interfaces__srv__MoveToPoint_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robopoint_interfaces__srv__MoveToPoint_Request__Sequence request;
  robopoint_interfaces__srv__MoveToPoint_Response__Sequence response;
} robopoint_interfaces__srv__MoveToPoint_Event;

// Struct for a sequence of robopoint_interfaces__srv__MoveToPoint_Event.
typedef struct robopoint_interfaces__srv__MoveToPoint_Event__Sequence
{
