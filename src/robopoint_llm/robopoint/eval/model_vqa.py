...
def eval_model(args):
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(model_path, args.model_base, model_name, load_4bit=args.load_4bit, load_8bit=args.load_8bit)

    # questions = load_dataset("wentao-yuan/where2place")
    # print(questions.keys())
    # questions = [json.dumps(item) for item in questions["train"]]
