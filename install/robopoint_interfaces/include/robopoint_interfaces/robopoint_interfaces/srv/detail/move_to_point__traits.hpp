...
[[deprecated("use robopoint_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const robopoint_interfaces::srv::MoveToPoint_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  robopoint_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use robopoint_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const robopoint_interfaces::srv::MoveToPoint_Event & msg)
{
  return robopoint_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<robopoint_interfaces::srv::MoveToPoint_Event>()
{
  return "robopoint_interfaces::srv::MoveToPoint_Event";
}

template<>
inline const char * name<robopoint_interfaces::srv::MoveToPoint_Event>()
{
  return "robopoint_interfaces/srv/MoveToPoint_Event";
}

template<>
struct has_fixed_size<robopoint_interfaces::srv::MoveToPoint_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<robopoint_interfaces::srv::MoveToPoint_Event>
  : std::integral_constant<bool, has_bounded_size<robopoint_interfaces::srv::MoveToPoint_Request>::value && has_bounded_size<robopoint_interfaces::srv::MoveToPoint_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<robopoint_interfaces::srv::MoveToPoint_Event>
  : std::true_type {};
